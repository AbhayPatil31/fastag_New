...
List<GetunallocaterequestcompletedDatum> completedrequest = [];

class UnallocatedRequestCompletePage extends StatefulWidget {
  String requestid;
  UnallocatedRequestCompletePage(this.requestid);
  State createState() => UnallocatedRequestCompletePageState();
}

class UnallocatedRequestCompletePageState
    extends State<UnallocatedRequestCompletePage> {
  Future<void> Networkcallforcompletedrequestlist() async {
    try {
      ...
      List<Object?>? list = await NetworkCall().postMethod(
          URLS().get_unallocate_request_completed_api,
          URLS().get_unallocate_request_completed_api_url,
          craetejsonString,
          context);
      if (list != null) {
        Navigator.pop(context);
        List<Getunallocaterequestcompletedresponse> response = List.from(list!);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Unallocated Request Completed',
